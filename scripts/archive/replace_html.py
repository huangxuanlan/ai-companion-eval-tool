...
# Replacement for the Role tab containing 基本信息, 关系与场景 and 系统模块
old_section = content[content.find('<div id="tab-role" class="tab-content active">'):content.find('<div id="tab-params" class="tab-content">')]

new_section = """<div id="tab-role" class="tab-content active">
        ...
        <div class="accordion">
          ...
          <div class="accordion-content">
            ...
            <div class="form-item"><label class="form-label">角色每周日程 {{weekly_schedule}}</label><textarea id="f-weekly-schedule" class="form-control" style="min-height:40px" placeholder="由于工作较忙..."></textarea></div>
            <div class="form-grid-2">
            ...
            <div class="form-item"><label class="form-label">阶段默认称呼 {{relation_calling}}</label><input type="text" id="f-relation-calling" class="form-control" placeholder="小姐姐/亲爱的"></div>
          </div>
        </div>
        ...
        <div class="accordion">
          ...
          <div class="accordion-content">
            ...
            <div class="form-item"><label class="form-label">性格行为细化 {{longform_persona}} <span style="font-weight:normal;color:var(--primary-color)">[Auto匹配|✏️编辑]</span></label><textarea id="f-sys-persona" class="form-control" style="min-height:60px"></textarea></div>
            ...
            <div class="form-item"><label class="form-label">Few-shot {{longform_few_shot}}</label><textarea id="f-sys-fewshot" class="form-control" style="min-height:40px"></textarea></div>
            ...
            <div class="form-item"><label class="form-label">画像 {{dialogueStartPrompt}}</label><textarea id="f-sys-startprompt" class="form-control" style="min-height:40px"></textarea></div>
            <div class="form-item"><label class="form-label">摘要 {{dialogue_summary}}</label><textarea id="f-sys-summary" class="form-control" style="min-height:40px"></textarea></div>
